...
const systemsProjects = [
  {
    ...
    desc: "A cross-platform web and mobile barangay service management system that digitizes public services for Barangay 3S+ Malanday. It features secure QR-verified resident feedback and an AI sentiment analysis engine that automatically categorizes community inputs into positive, negative, and neutral insights to optimize response times.",
    tech: [
      {
        label: (
          <>
            <i
              className="fa-brands fa-js mr-1"
              style={{ color: "#F7DF1E" }}
            ></i>
            JavaScript
          </>
      ...
      },
      {
        label: (
          <>
            <i
              className="fa-brands fa-square-js mr-1"
              style={{ color: "#3178C6" }}
            ></i>
            TypeScript
          </>
      ...
      },
      {
        label: (
          <>
            <i
              className="fa-solid fa-fire mr-1"
              style={{ color: "#FFCA28" }}
            ></i>
            Firebase
          </>
  ...
  },
  {
    ...
    tech: [
      ...
      },
      {
        label: (
          <>
            <i
              className="fa-solid fa-database mr-1"
              style={{ color: "#0a6ea6" }}
            ></i>
            SQLite
          </>
    ...
    links: [
      {
        href: "https://github.com/jascify/Quiz-IT",
        icon: "fa-brands fa-github",
        label: "Code",
      },
      {
        href: "https://quiz-it-qyw0.onrender.com/",
        icon: "fa-solid fa-link",
        label: "Live",
      },
    ],
    img: "/assets/quiz-it.png",
    caption: "Quiz-IT",
  },
  {
    ...
    tech: [
      {
        label: (
          <>
            <i
              className="fa-brands fa-html5 mr-1"
              style={{ color: "#E34F26" }}
            ></i>
            HTML
          </>
      ...
      },
      {
        label: (
          <>
            <i
              className="fa-brands fa-css3-alt mr-1"
              style={{ color: "#1572B6" }}
            ></i>
            CSS
          </>
      ...
      },
      {
        label: (
          <>
            <i
              className="fa-brands fa-php mr-1"
              style={{ color: "#777BB4" }}
            ></i>
            PHP
          </>
    ...
    links: [
      {
        href: "https://github.com/kerbyllamosocruz/bask-cafe.vercel.app",
        icon: "fa-brands fa-github",
        label: "Code",
      },
      {
        href: "https://bask-cafe.vercel.app",
        icon: "fa-solid fa-link",
        label: "Live",
      },
    ],
    img: "/assets/bask-cafe.png",
    caption: "Bask Cafe Website",
  },
  {
    title: "WinForms OOP",
    role: "Developer",
    ...
    tech: [
      {
        label: (
          <>
            <i
              className="fa-brands fa-microsoft mr-1"
              style={{ color: "#00A4EF" }}
            ></i>
            C#
          </>
      ...
      },
      {
        label: (
          <>
            <i
              className="fa-solid fa-window-restore mr-1"
              style={{ color: "#68217A" }}
            ></i>
            WinForms
          </>
    ...
    links: [
      {
        href: "https://github.com/jascify/WinForms-OOP",
        icon: "fa-brands fa-github",
        label: "Code",
      },
    ],
    img: "/assets/winforms-oop.png",
    caption: "WinForms OOP",
  },
];
...
const uiProjects = [
  {
    title: "LinguaLink",
    desc: "A mobile application concept that gamifies language learning, enabling users to track their progress and unlock educational modules using earned energy points.",
    embedSrc:
      "https://embed.figma.com/design/ZoLeqXUzhuVmUEAv6bTTqb/LinguaLink?node-id=0-1&embed-host=share",
    figmaHref:
  ...
  {
    title: "3S+ Sense",
    desc: "The UI/UX design for the 3S+ Sense barangay services web, focusing on accessibility and ease of use.",
    embedSrc:
  ...
  {
    title: "ValCommuters",
    desc: "A mobile app design for Valenzuela City commuters, aimed at providing real-time transport information and a better commuting experience.",
    embedSrc:
      "https://embed.figma.com/design/4Wn9kyqFRo8xuSUUVxvtLG/Val-Commuters?node-id=12-539&embed-host=share",
    figmaHref:
      "https://www.figma.com/design/4Wn9kyqFRo8xuSUUVxvtLG/Val-Commuters?node-id=12-539",
  },
];
    ...
    tech: [
      ...
      },
      {
        label: (
          <>
            <i
              className="fa-solid fa-chart-column mr-1"
              style={{ color: "#F2C811" }}
            ></i>
            Power BI
          </>
...
export default function Projects({ theme, openLightbox }) {
  ...
  return (
    <section
      id="projects"
      className={`${bg} py-[100px] px-[6%] text-center transition-colors`}
    >
      <div className="mb-[50px]">
        <p className="text-[#6abf69] uppercase tracking-[2px] font-bold text-[0.85rem] mb-[10px]">
          Portfolio
        </p>
        <h2 className={`text-[2.4rem] font-bold ${textDark}`}>
          Selected Works
        </h2>
      </div>
      ...
      <div className="max-w-[1100px] mx-auto text-left">
        ...
        {/* Folder Content */}
        <div
          className={`${bgRaised} ${borderPrimary} border rounded-[0_16px_16px_16px] p-9 shadow-[0_10px_40px_rgba(0,0,0,0.2)] relative z-[1]`}
        >
          {/* Systems Tab */}
          {activeTab === "systems" && (
                ...
                >
                  <div className="flex flex-col gap-[10px]">
                    <div className="flex flex-col gap-[6px]">
                      <span className="text-[0.68rem] font-extrabold uppercase tracking-[1.5px] text-[#6abf69]">
                        {p.role}
                      </span>
                      <h3 className={`text-[1.25rem] font-bold ${textDark}`}>
                        {p.title}
                      </h3>
                    </div>
                    <p className={`text-[0.82rem] leading-[1.6] ${textGray}`}>
                      {p.desc}
                    </p>
                    <div className="flex items-center justify-between gap-3 flex-wrap mt-[6px]">
                      <div className="flex flex-wrap gap-[5px]">
                        {p.tech.map((t, i) => (
                          <span
                            key={i}
                            className={`text-[10px] px-2 py-[3px] rounded-[4px] font-semibold border
                  ...
                  <div
                    className={`w-full md:w-[420px] h-[240px] rounded-[10px] overflow-hidden border cursor-pointer relative group ${border}`}
                    onClick={() => openLightbox(p.img, p.caption)}
                  >
                    <img
                      src={p.img}
                      alt={p.title}
                      className="w-full h-full object-cover transition-all duration-400 group-hover:scale-[1.06] group-hover:brightness-50"
                    />
          ...
          {activeTab === "ui" && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {uiProjects.map((p) => (
                <div
                  key={p.title}
                  className={`${bgCard} rounded-[12px] border overflow-hidden transition-all hover:-translate-y-[3px] hover:shadow-[0_12px_40px_rgba(46,125,50,0.1)] hover:border-[rgba(76,175,80,0.22)] ${border}`}
                >
          ...
          {activeTab === "graphics" && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {graphicsProjects.map((p, i) => (
                ...
                >
                  <div
                    className="w-full h-[210px] relative group cursor-pointer overflow-hidden"
        ...
        {/* Data Analysis Strip */}
        <div
          className={`mt-7 ${bgCard} ${borderPrimary} border rounded-[16px] p-7 transition-colors`}
        >
          <div
            className={`flex flex-col gap-[10px] mb-6 pb-[18px] border-b border-dashed ${border}`}
          >
            ...
            <p className={`text-[0.88rem] ${textGray}`}>
              Exploratory data projects using Python, Jupyter, and Power BI.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6">
            {daProjects.map((p, i) => (
              ...
              >
                <div
                  className="w-full h-full min-h-[260px] relative overflow-hidden group cursor-pointer"
                  style={{ direction: "ltr" }}
                  onClick={() => openLightbox(p.img, p.title)}
                >
                  <img
                    src={p.img}
                    alt={p.title}
                    className="w-full h-full object-cover object-top-left transition-all duration-500 group-hover:scale-[1.03] group-hover:brightness-50"
                  />
                ...
                >
                  <h3
                    className={`text-[1.15rem] font-bold mb-[6px] ${textDark}`}
                  >
                    {p.title}
                  </h3>
                  <p
                    className={`text-[0.82rem] leading-[1.6] mb-[14px] ${textGray}`}
                  >
                    {p.desc}
                  </p>
